...
const Privacy = () => {
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Typography>
        Muhammad Umer built the Rocket Bumpy game as an Ad Supported game. This
        SERVICE is provided by Muhammad Umer at no cost and is intended for use
        ...
        Conditions, which is accessible at Rocket Bumpy unless otherwise defined
        ...
        with certain personally identifiable information. The information that I
        request will be retained on your device and is not collected by me in
        any way. The game does use third party services that may collect
        information used to identify you. Link to privacy policy of third party
        service providers used by the game Google Play Services Log Data I want
        to inform you that whenever you use my Service, in a case of an error in
        the game I collect data and information (through third party products)
        ...
        operating system version, the configuration of the game when utilizing
        ...
        explicitly. However, the game may use third party code and libraries
        ...
        us in analyzing how our Service is used. I want to inform users of this
        ...
        site. Note that these external sites are not operated by me. Therefore,
        I strongly advise you to review the Privacy Policy of these websites. I
        have no control over and assume no responsibility for the content,
        privacy policies, or practices of any third-party sites or services.
        Children’s Privacy These Services do not address anyone under the age of
        13. I do not knowingly collect personally identifiable information from
        ...
        that I will be able to do necessary actions. Changes to This Privacy
        ...
        Policy, do not hesitate to contact me at uastudio2023@gmail.com.
      </Typography>
    </Box>
  );
};
